...
# Viro
job-description-virologist = Изучайте распространяющиеся вирусы, производите лекарства для больных членов экипажа, экспериментируйте с созданием полезных вирусов. Следите за тем, чтобы пандемии не распространялись.
