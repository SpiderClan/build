...
ent-ExecutiveIDCard = карта доступа руководителя
    .desc = Сотрудники Nanotrasen юридически обязаны подчиняться человеку, у которого это имеется. Также устройство способно обходить блокировки доступа на большинстве терминалов и приборов.
...
ent-CentcomIDCardNavyCaptain = ID-карта капитана ВКФ
    .desc = { ent-IDCardStandard.desc }
...
ent-VirologistIDCard = ID-карта вирусолога
    .desc = Карта необходима для доступа в различные зоны на станции.
